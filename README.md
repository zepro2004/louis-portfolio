...
![Analytics](https://img.shields.io/badge/Analytics-Vercel-000000?style=for-the-badge&logo=vercel)
...
- 🏗️ **Custom Hooks Architecture** - Clean separation of logic and presentation
- 📧 **Contact Form** - Functional contact form with validation and toast notifications
- 🖼️ **Project Showcase** - Filterable project gallery with carousel and grid views
...
- 🏷️ Filterable by category (Web, Desktop, Utility)
...
> 💡 **New!** 🐳 Docker support with intelligent rebuild detection and multi-registry deployment options
...
🎨 **Beautiful** | 🔄 **Consistent** | ♿ **Accessible** | 📱 **Responsive**

</div>

The portfolio uses a carefully crafted design system:
- 🌈 **Color Palette**: Professional blues and grays with vibrant accent colors
- 📝 **Typography**: Modern, readable font stack optimized for web
- 📏 **Spacing**: Consistent spacing scale using CSS variables
- 🧩 **Components**: Reusable UI components for design consistency
- ✨ **Animations**: Smooth transitions and delightful hover effects
...
Components are thoughtfully organized by purpose:
...
- 🖱️ **useHoverEffects**: Centralized hover effect management
...
- ⚛️ Efficient React component structure
...
### 🗂️ Legacy Deployment Options

#### 📄 Deploy to Netlify
1. 🔗 Connect your GitHub repository to Netlify
2. ⚙️ Set build command: `npm run build`
...
3. **🚀 Add New Projects**
   ...
   - 🖼️ Include project images in `src/assets/images/projects/`
   - 🏷️ Update project categories if needed
